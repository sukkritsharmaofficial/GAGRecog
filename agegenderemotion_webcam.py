# COMPUTER VISION
# Deep Learning - modesls - encoders-
...
def process_facedetection(model_detector, model_poseestimator, model_ageestimator, model_genderestimator, cam_resolution, cam_index):   #model_emotionestimator
